...
const destDir = path.resolve(__dirname, 'src/app/[locale]/csr');
const destPath = path.resolve(destDir, 'page.tsx');
const sourcePath = path.resolve(__dirname, '../files (2)/asia-group-website/csr/index.html');
...
console.log('CSR page replicated successfully.');
