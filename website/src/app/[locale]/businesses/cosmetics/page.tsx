...
export default function CosmeticsPage() {
  ...
  *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
  ...
  .cards-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:2px;background:rgba(255,255,255,0.04);margin-top:60px;}
  .card{background:var(--dark-2);padding:40px 32px;transition:background .3s;}.card:hover{background:var(--dark-3);}
  .card-icon{font-size:32px;margin-bottom:18px;display:block;}
  .card-name{font-family:var(--font-condensed);font-size:17px;font-weight:700;letter-spacing:0.05em;text-transform:uppercase;color:var(--white);margin-bottom:8px;}
  .card-sub{font-family:var(--font-condensed);font-size:11px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:var(--silver-light);margin-bottom:12px;}
  .card-desc{font-size:13px;line-height:1.7;color:rgba(255,255,255,0.45);font-weight:300;}
  ...
  .market-section{padding:120px 60px;background:var(--dark-3);}
  .market-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:2px;background:rgba(255,255,255,0.04);margin-top:60px;}
  .market-card{background:var(--dark-2);padding:32px 24px;}
  .market-icon{font-size:28px;margin-bottom:14px;}
  .market-name{font-family:var(--font-condensed);font-size:14px;font-weight:700;letter-spacing:0.06em;text-transform:uppercase;color:var(--white);margin-bottom:8px;}
  .market-desc{font-size:13px;font-weight:300;line-height:1.65;color:rgba(255,255,255,0.45);}
  .market-count{font-family:var(--font-condensed);font-size:22px;font-weight:700;color:var(--silver-light);margin-top:14px;}
...
<section style="padding:100px 60px;background:var(--dark);">
  <div style="max-width:1300px;margin:0 auto;">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:2px;background:rgba(255,255,255,0.04);">
      ...
      <!-- Location card — replicate for each Asia Cosmetics location. Fill from field visit data. -->
      <div style="background:var(--dark-2);overflow:hidden;">
        ...
        <div style="padding:20px 20px 24px;">
          <div style="font-family:var(--font-condensed);font-size:10px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:#CE93D8;margin-bottom:6px;">Asia Cosmetics — Location [ N ]</div>
